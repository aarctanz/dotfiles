...
\begin{tikzpicture}[
    ...
    % \node[on] (Suss) {$S_0(t)$};
    \node[on] (Suss)    {$S_0(t)$};
    \node[on] (Inff)  [below= of Suss]    {$I_0(t)$};
    \node[on] (Recc)  [below= of Inff]    {$R_0(t)$};

    \node[yn] (Susy) [right = of Suss]   {$S(t)$};
    \node[yn] (Infy) [right= of Inff] {Infectious $I(t)$};
    \node[yn] (Recy) [right= of Recc] {Recovered $R(t)$};
