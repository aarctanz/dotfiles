...
//explain mailScaler
// mailScaler is a GraphQLScalarType that is used to define a new scalar type in GraphQL
// parseValue is used to parse the value that is passed from the client to the server
// serialize is used to parse the value that is passed from the server to the client
// in this case, we are checking if the value is a string and if it matches the mailRegex pattern
// if it does not match the pattern, we throw an error
// if it matches the pattern, we return the value
