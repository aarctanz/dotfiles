ALTER TABLE cases_clean ADD COLUMN defendant_gender INT;
ALTER TABLE cases_clean ADD COLUMN petitioner_gender INT;
...
ALTER TABLE cases_clean 
DROP COLUMN female_petitioner,
RENAME COLUMN petitioner_gender TO female_petitioner;
