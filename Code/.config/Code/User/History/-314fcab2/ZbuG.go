...
func (s *Scanner) boolean() {
	for s.peek() != "e" {
		s.advance()
	}
	s.advance()
	s.addTokens(BOOLEAN, nil)
}
...
func (s *Scanner) scanToken() {
	...
	case "}":
		s.addTokens(RIGHT_BRACE, nil)
	case "[":
		s.addTokens(LEFT_BRACKET, nil)
	case "]":
		s.addTokens(RIGHT_BRACKET, nil)
	case ",":
		s.addTokens(COMMA, nil)
	case ".":
		s.addTokens(DOT, nil)
	case "-":
		s.addTokens(MINUS, nil)
	case "+":
		s.addTokens(PLUS, nil)
	case "e":
		s.addTokens(EXPONENT, nil)
	case "t":
